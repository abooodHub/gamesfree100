...
def update_timestamps():
    ...
    # قائمة ملفات JSON
    json_files = [
        '../data/free_goods_detail.json',
        '../data/epic_goods_detail.json',
        '../data/gog_goods_detail.json',
        '../data/ubisoft_goods_detail.json',
        '../data/playstation_goods_detail.json',
        '../data/xbox_goods_detail.json'
    ]
