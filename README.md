...
موقع ثابت مستضاف على GitHub Pages يعرض الألعاب المدفوعة التي أصبحت مجانية مؤقتًا بخصم 100% من Steam وEpic Games. لا يعرض ألعاب Free to Play أو الخصومات الأقل من 100%. تُحدّث البيانات آليًا كل 6 ساعات عبر GitHub Actions.
...
├── script.js                   # العرض والفلترة واللغة والمظهر
...
├── cleanup_now.py              # تشغيل يدوي لجلب وتنظيف عروض Steam
...
يعمل جلب المتجرين بصورة مستقلة، لذلك لا يمنع تعطل متجر واحد تحديث الآخر. عند تعذر التحقق لا تُحذف عروض ذلك المتجر لمجرد خطأ شبكة. تُكتب ملفات JSON بطريقة ذرّية لتقليل احتمال تلفها إذا انقطع التنفيذ.
